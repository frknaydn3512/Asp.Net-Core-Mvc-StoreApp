    ...
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                ...
                new Product() { ProductId = 7, CategoryId=1,ImageUrl="/images/7.jpg", ProductName = "Hamlet", Price = 1_500 , ShowCase = false},
                new Product() { ProductId = 8, CategoryId=1,ImageUrl="/images/7.jpg", ProductName = "Livanur", Price = 1_500 , ShowCase = true},
                new Product() { ProductId = 9, CategoryId=2,ImageUrl="/images/7.jpg", ProductName = "Furkan", Price = 2_500 , ShowCase = true},
                new Product() { ProductId = 10, CategoryId=1,ImageUrl="/images/7.jpg", ProductName = "Gencay", Price = 3_500 , ShowCase = true}
            );
        }
    }
}